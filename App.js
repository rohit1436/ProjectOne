...
const HomeStackNavigator = () => {
  return(
    ...
    <Stack.Screen name='Home' component={HomeScreen} options={{
      title:'Instagram',
      headerLeft:() => <TouchableOpacity><FaIonicons name='camera' size={25}  /></TouchableOpacity>,
      headerRight:() => <TouchableOpacity><Ionicons name='paper-plane-outline' size={25}  /></TouchableOpacity>,
      ...
      screenOptions={({ route }) => ({
          tabBarIcon: ({ focused, color ,size=25 }) => {
            ...
            if (route.name === 'Profile') {
              ...
              // color = focused ? 'white' : 'orange'
              return focused ?  <View style={{borderRadius:16,borderWidth:1,justifyContent:'center',alignItems:'center',width:32,height:32,borderColor:'#000'}}>
                <Ionicons name={iconName} size={20} color={color} />
              </View> : <Ionicons name={iconName} size={size} color={color} />  ;
            }
          },
        })}
      >
